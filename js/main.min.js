...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const btn = document.querySelectorAll('.header-position__btn');
    const progress = document.querySelectorAll('.header-position__status');
    let counter = 1;
   

   btn.forEach((btn, btnIndex) =>{
    btn.addEventListener('click', () => {
        ...
        header[btnIndex].style.display = 'none';
        header[btnIndex + 1].style.display = 'flex';
    })
   })


   
   header.forEach((formItem, formItemIndex) => {
